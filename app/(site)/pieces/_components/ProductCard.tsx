...
import { siteAssets } from "@/lib/assets/site"
      ...
      <div className="relative group">
        ...
        >
          <Image
            ...
            className={`object-contain w-full h-full md:transition-transform md:duration-500 md:ease-out md:group-hover:scale-[1.03] ${!isAvailable ? 'brightness-45 saturate-35' : ''}`}
          />
        </TransitionLink>
